...
//                .getResultList();
	...
	public List<Produto> getProdutos(String nome, Integer categoriaId, Integer lojaId) {
		...
		CriteriaQuery<Produto> query = criteriaBuilder.createQuery(Produto.class); // criteriaquery é onde conseguimos fazer a montagem da query.
		Root<Produto> root = query.from(Produto.class); // através do root podemos traçar o caminho até os atributos.
