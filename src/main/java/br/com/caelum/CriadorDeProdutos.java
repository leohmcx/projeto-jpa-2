	...
	public void init() {
		...
		template.execute(new TransactionCallbackWithoutResult() {
			...
			protected void doInTransactionWithoutResult(TransactionStatus status) {
				...
				livroDeArquitetura.setDescricao("Neste livro, os autores, conhecidos especialistas da Área, apresentam muitos tópicos que aparecem com frequencia na plataforma"
				+ " Java, incluindo desde modelagem e design das classes, até detalhes importantes das tecnologias mais utilizadas.Sempre com uma visão técnica e prática "
				+ "capaz de elucidar muitas questões enfrentadas tanto pelo profissional iniciante quanto por aquele que estão adquirindo mais experiência na plataforma.");
				...
				livroDeSpring.setDescricao("Criado para simplificar o desenvolvimento de aplicações Java, o Spring se tornou um dos frameworks de mais destaque dentro "
				+ "desse grande ambiente. Aprenda muito mais que o básico do Spring, desde o tradicional Container de Inversão de Controle e Injeção de Dependências, "
				+ "passando pelos robustos módulos de segurança, transações, programação orientada a aspectos e também o fantástico módulo MVC, o SpringMVC.");
				...
				violao.setLinkDaFoto("https://images-na.ssl-images-amazon.com/images/I/711oFjr65lL._AC_SX290_SY290_.jpg");
				em.persist(violao);
