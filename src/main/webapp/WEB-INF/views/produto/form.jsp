		...
		<div class="container">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form:form action="${spring:mvcUrl(\"cadastraProduto\").build()}" method="post">
						...
						<div class="form-group">
							<label for="nome"> Loja: </label> <select name="loja.id" class="form-control">
							...
							<c:forEach items="${categorias}" var="categoria" varStatus="status">
								...
								<c:choose>
									<c:when test="${contains}">
										<input type="checkbox" name="categorias" value="${categorias[status.index].id}" checked />${categoria.nome}
										<br>
										<c:set var="contains" value="false" />
									</c:when>
									<c:when test="${not contains }">
										<input type="checkbox" name="categorias" value="${categorias[status.index].id}" />${categoria.nome}
										<br>
									</c:when>
								</c:choose>
							</c:forEach>
